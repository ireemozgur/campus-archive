export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-16">
      <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">Gizlilik Politikası</h1>
      <div className="space-y-4 text-zinc-600 leading-relaxed dark:text-zinc-400">
        ...
        <h2 className="pt-4 text-xl font-semibold text-zinc-900 dark:text-zinc-100">Toplanan Bilgiler</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-semibold text-zinc-900 dark:text-zinc-100">Bilgilerin Kullanımı</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-semibold text-zinc-900 dark:text-zinc-100">Çerezler</h2>
        <p>
        ...
        <h2 className="pt-4 text-xl font-semibold text-zinc-900 dark:text-zinc-100">İletişim</h2>
        <p>
